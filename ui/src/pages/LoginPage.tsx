...
export function LoginPage() {
  ...
  // Handle Google OAuth callback — detect ?code= query param
  useEffect(() => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-purple-950 via-purple-900 to-purple-950">
      <div className="w-full max-w-sm space-y-8 px-6">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/20 bg-white px-4 py-3 text-sm font-medium text-gray-800 transition hover:bg-gray-50 disabled:opacity-50"
        >
