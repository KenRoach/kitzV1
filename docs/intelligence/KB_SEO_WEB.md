# SEO & Web — KITZ Knowledge Base Intelligence
...
### Google Search Central [High]

- **ID:** PKB-173
- **Type:** Docs
- **URL:** https://developers.google.com/search
- **Why KITZ Needs It:** Official SEO documentation & best practices
...
Google Search Central, formerly Google Webmasters, is here to help the right people view your content with resources to make your website discoverable to Google Search. New to SEO? Start by reading this introductory guide to SEO.
Get started
Case study
...
Read the case study
Case study
MX Player boosts organic traffic 3x
After adding Video structured data and following best practices, MX Player saw over 3x growth in traffic from Google and a 100% increase of video page views per user session on their platform from organic Search traffic.
Read the case study
Case study
ZipRecruiter grows conversion rate 4.5x
After the launch of
JobPosting
structured data, Google organic traffic to ZipRecruiter job pages converted at a rate three times higher than organic traffic from other search engines.
Read the case study
Check out what's new on Google Search Central
...
### Moz Beginner SEO Guide [Medium]

- **ID:** PKB-174
- **Type:** Guide
- **URL:** https://moz.com/beginners-guide-to-seo
- **Why KITZ Needs It:** Foundational SEO knowledge for SMBs
...
- **Why KITZ Needs It:** Monitor search performance & fix issues
