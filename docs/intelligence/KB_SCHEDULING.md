# Scheduling — KITZ Knowledge Base Intelligence
...
- **Why KITZ Needs It:** Appointment scheduling for service businesses
...
### Cal.com (Open Source) [High]

- **ID:** PKB-172
- **Type:** Platform
- **URL:** https://cal.com/
- **Why KITZ Needs It:** Open-source scheduling infrastructure
