...
export const TEAM_DEFINITIONS: TeamConfig[] = [
  // Customer-facing teams
  {
    ...
    lead: 'HeadCustomer',
    members: ['WAFlowDesigner', 'MessageTemplater', 'DeliveryMonitor', 'EscalationBot'],
  ...
  },
  {
    ...
    lead: 'CRO',
    members: ['LeadScorer', 'PipelineOptimizer', 'OutreachDrafter', 'DealCloser'],
  ...
  },
  {
    ...
    lead: 'CMO',
    members: ['ContentCreator', 'SEOAnalyst', 'CampaignRunner', 'SocialManager'],
  ...
  },
  {
    ...
    lead: 'HeadGrowth',
    members: ['ActivationOptimizer', 'RetentionAnalyst', 'ReferralEng', 'FunnelDesigner'],
  ...
  },
  {
    ...
    lead: 'HeadEducation',
    members: ['TutorialBuilder', 'DocWriter', 'VideoScripter', 'FAQBot'],
  ...
  },
  {
    ...
    lead: 'customerVoice',
    members: ['TicketRouter', 'SatisfactionBot', 'ChurnPredictor', 'FeedbackAggregator'],
  ...
  },
  {
    ...
    members: ['CopyWriter', 'TranslationBot', 'BrandVoiceBot', 'AssetManager', 'BackendCopyWriter'],
  ...
  // Backend engineering teams
  {
    ...
    members: ['InfraOps', 'ServiceMesh', 'DBAdmin', 'APIDesigner'],
  ...
  },
  {
    ...
    lead: 'CPO',
    members: ['UIArchitect', 'ComponentDev', 'A11ySpec', 'PerformanceOpt'],
  ...
  },
  {
    ...
    displayName: 'Backend',
    lead: 'CTO',
    members: ['SystemDesigner', 'DataModeler', 'IntegrationEng', 'SecurityEng'],
  ...
  },
  {
    ...
    lead: 'COO',
    members: ['PipelineEng', 'ContainerOps', 'MonitoringEng', 'ReleaseManager'],
  ...
  },
  {
    ...
    lead: 'Reviewer',
    members: ['TestArchitect', 'E2ERunner', 'LoadTester', 'RegressionBot'],
  ...
  // Backend support teams
  {
    ...
    members: ['PromptEng', 'ModelEval', 'RAGSpecialist', 'FineTuneOps'],
  ...
  },
  {
    ...
    lead: 'CFO',
    members: ['InvoiceBot', 'RevenueTracker', 'CostOptimizer', 'ComplianceAuditor'],
  ...
  },
  {
    ...
    members: ['PanamaComplianceBot', 'PrivacyAuditor', 'TOS_Monitor', 'DataRetention'],
    description: 'Panama compliance, privacy, terms enforcement, data retention',
  },
  {
    name: 'strategy-intel',
    displayName: 'Strategy / Intel',
    lead: 'Chair',
    members: ['MarketScanner', 'CompetitorTracker', 'TrendAnalyst', 'OpportunityBot'],
  ...
  },
  {
    ...
    lead: 'FocusCapacity',
    members: ['SprintPlanner', 'ResourceAllocator', 'RiskMonitor', 'ProgressTracker'],
    description: 'Sprint planning, resource allocation, risk monitoring, progress tracking',
  },
  {
    name: 'coaches',
    displayName: 'Coaches & Skill Trainers',
    lead: 'FeedbackCoach',
    members: ['AgentSkillTrainer', 'PlaybookCoach', 'OnboardingCoach', 'ProcessCoach'],
