    ...
    // ── 2. Generate Real PDF Binary via pdfkit ──
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          footer: { type: 'string', description: 'Footer text (default: "Generated by KITZ")' },
      ...
      execute: async (args, traceId) => {
        try {
          ...
          doc.fontSize(10).fillColor('#999999')
            .text(`KITZ · ${new Date().toLocaleDateString('es-PA', { year: 'numeric', month: 'long', day: 'numeric' })}`, { align: 'right' })
            .moveDown(0.5);
          ...
          // Footer
          doc.moveDown(2);
          const footer = String(args.footer || 'Generated by KITZ');
